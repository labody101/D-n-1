...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "UPDATE tai_khoan SET user = '$user', pass = '$pass', anh_dai_dien = '$anh', email = '$email', diachi = '$diachi', sdt = '$sdt', vai_tro = '$vaitro' where ma_kh = $id";
    pdo_execute($sql);
...
<div class="row">
    <form action="capnhat_ttcn.php?ma_kh=<?=$tt['ma_kh']?>" method="post" enctype="multipart/form-data">
        ...
        <br>
        <input type="text" name="vai_tro" value="<?=$tt['vai_tro']?>" placeholder="Vai trò">
        <br>
